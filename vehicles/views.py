...
@permission_required('vehicles.view_vehicleentry')
...
@permission_required('vehicles.add_vehicleentry')
...
@permission_required('vehicles.change_vehicleentry')
...
@permission_required('vehicles.delete_vehicleentry')
...
@permission_required('vehicles.manage_trash')
